...
define(["dojo/Evented",
  ...
  //测绘楼盘表导入模板
  var lpbImportFwTpl = '<div class="info-box" data-uid="{{uid}}">' +
    '<div>' +
    ...
    '<span class="info-box-subtitle">{{subtitle1}}{{#blankData subtitle1}}{{/blankData}}</span>' +
    '<span class="info-box-subtitle">{{subtitle2}}{{#blankData subtitle2}}{{/blankData}}</span>' +
    '<span class="info-box-subtitle">{{subtitle3}}{{#blankData subtitle3}}{{/blankData}}</span>' +
    '<span class="info-box-subtitle">房屋类型: <select id="{{uid}}" class="fwlxOptions"><option selected disabled value="">请选择</option><option value="1">项目内多幢房屋</option><option value="2">独幢房屋</option><option value="3">层</option><option value="4">户</option></select></span>' +
    '</div></div>';

  var lpbImportZdTpl = '<div class="info-box" data-uid="{{uid}}">' +
    '<div>' +
    '<span class="info-box-import text-primary" data-uid="{{uid}}">{{importname}}</span>' +
    '</div>' +
    '<div class="info-box-content" data-uid="{{uid}}">' +
  ...
  function renderTpl(data) {
    ...
    switch (_type) {
      ...
      case 'boxloc':
        ...
        break;
      case 'fwLpbImport':
        source = lpbImportFwTpl;
        break;
      case 'zdLpbImport':
        source = lpbImportZdTpl;
        break;
    }
