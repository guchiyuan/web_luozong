...
define(["dojo/Evented",
  ...
  var fwxmEditAndDeleteTpl = '<div class="info-box">' +
    '<div class="info-box-opt">' +
  ...
  var fwdzEditAndDeleteTpl = '<div class="info-box">' +
    '<div class="info-box-opt">' +
    '<span class="text-primary info-box-btn-edit" title="查看" data-uid="{{uid}}" style="font-size:15px">查看</span>' +
    '<span class="text-primary info-box-btn-delete" title="删除" data-uid="{{uid}}" style="font-size:15px">删除</span>' +
    '</div>' +
    '<div class="info-box-content">' +
    '<span class="info-box-title text-primary">{{LSZD}}</span>' +
    '<span class="info-box-subtitle">{{FWMC}}</span>' +
    '</div></div>';
  ...
  function renderTpl(data) {
    ...
    switch (_type) {
      ...
      case 'export':
        source = exportTpl;
        break;
      case 'fwxm_editAndDel':
        source = fwxmEditAndDeleteTpl;
        break;
      case 'fwdz_editAndDel':
        source = fwdzEditAndDeleteTpl;
        break;
    }
